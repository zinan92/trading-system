...
class CEigen(CKLine_Combiner[CBi]):
    ...
    def update_fx(self, _pre: 'CEigen', _next: 'CEigen', exclude_included=False, allow_top_equal=None,target_type=CBi):
        super(CEigen, self).update_fx(_pre, _next, exclude_included, allow_top_equal,CBi)
